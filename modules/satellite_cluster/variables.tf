...
##################################################################################
# ibm_woker_host_1_id - The VPC VSI instance ID for the compute server
##################################################################################
variable "ibm_worker_host_1_id" {
  type        = string
  default     = ""
  description = "The VPC VSI instance ID for the compute server"
}

##################################################################################
# ibm_worker_host_2_id - The VPC VSI instance ID for the compute server
##################################################################################
variable "ibm_worker_host_2_id" {
  type        = string
  default     = ""
  description = "The VPC VSI instance ID for the compute server"
}
...
##################################################################################
# ibm_worker_host_3_id - The VPC VSI instance ID for the compute server
##################################################################################
variable "ibm_worker_host_3_id" {
  type        = string
  default     = ""
  description = "The VPC VSI instance ID for the compute server"
}
